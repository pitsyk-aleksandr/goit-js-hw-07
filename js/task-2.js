// Завдання 2. Підрахунок категорій та елементів в кожній категорії.
...
// Пошук елемента - списка зображень - к класом gallery
const galleryList = document.querySelector('.gallery');

// Повна розмітка вкладень списку
let markup = ``;

images.forEach((image) => {
  // Створення розмітки для одного li
  const markLi = `
  <li class="gallery-item">
    <img src="${image.url}" alt="${image.alt}" class="gallery-image">
  </li>`;
  // Додавання до загальної розмітки
  markup = markup + markLi;
});
